...
export const questionsFeedback: FeedbackQuestion[] = [
  ...
  },
  {
    ...
    answers: [
      {
        label: 'Male-attracted',
        color: '#003399',
        effect: 'Male',
      },
      {
        label: 'Female-attracted',
        color: '#990000',
        effect: 'Female',
      },
      {
  ...
  },
  {
    ...
    answers: [
      {
        label: 'Engaged/Married/Civil Union',
        color: '#AFAF4C',
        effect: 'Engaged',
      },
      {
        label: 'Mono Relationship',
        color: '#4C96AF',
        effect: 'Mono',
      },
      {
        label: 'Poly Relationship',
        color: '#6D4CB0',
        effect: 'Poly',
      },
      {
  ...
  },
  {
    id: 5,
    question:
      'How many different sexual partners have you had in the last 3 months?',
    questionType: 'smallSelection',
    answers: [
      {
        label: '3 or more',
  ...
  {
    id: 6,
    question: 'How sexually active have you been in the last 3 months?',
    questionType: 'smallSelection',
    answers: [
      {
        label: 'Regularly, once a week or more',
        color: '#321b5e',
        effect: 'Regular',
      },
      {
  ...
  {
    id: 7,
    question: 'How old are you? (16-99)',
  ...
  },
  {
    ...
    answers: [
      {
        label: 'Professional (MSc and above)',
        color: '#afaf4c',
        effect: 'Professional',
      },
      {
        label: 'Higher (BSc or College)',
        color: '#d1d16d',
        effect: 'Higher',
      },
      {
  ...
  {
    id: 12,
    question: 'What class would you consider yourself as?',
    questionType: 'smallSelection',
    answers: [
      {
        label: 'Upper Class',
  ...
  {
    id: 14,
    question: 'What describes your ethnicity the best?',
    questionType: 'bigSelection',
    answers: {
      EastEuro: 'Eastern European',
      WestEuro: 'Western European',
      SouthEuro: 'Southern European',
      MidEast: 'Middle-Eastern',
      African: 'Sub-Saharan African',
      EastAsia: 'Eastern Asian',
      SEAsia: 'South-Eastern Asian',
      SouthAsia: 'Southern Asian',
      Other: 'Other',
    },
  },
  {
    id: 15,
    question: 'What sort of place do you live in?',
    questionType: 'smallSelection',
    answers: [
      {
        label: 'Bigger City',

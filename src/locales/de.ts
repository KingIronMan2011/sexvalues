const de = {
  ...
  "home": {
    ...
    "whatIsParagraph2": ", das versucht, Ihre Sexualität abzubilden. Ihnen wird eine Aussage gezeigt und Sie antworten mit Ihrer Meinung dazu, von",
    "whatIsParagraph3": "bis",
    "whatIsParagraph4": ". Jede Antwort beeinflusst Ihre Werte leicht. Am Ende werden Ihre Antworten mit den maximal möglichen Werten verglichen und als Prozentsatz angezeigt. Antworten Sie ehrlich!",
    ...
    "valuesIntro": "Es gibt fünf Achsen, und jeder sind zwei gegensätzliche Werte zugeordnet.",
    "contact": "Kontakt",
    "privacy": "Datenschutz",
    "privacyText": "Diese Seite kann Google Analytics verwenden, wenn Sie Analyse-Cookies akzeptieren. Am Ende des Tests können Sie außerdem allgemeine demografische Angaben machen.",
    "licensing": "Lizenz",
  ...
  "feedback": {
    "allDone": "Fertig!",
    "seriousQuestion": "Haben Sie diesen Test ernsthaft (oder zumindest nicht ironisch) ausgefüllt?",
